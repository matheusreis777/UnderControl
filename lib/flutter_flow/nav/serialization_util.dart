  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case TipoServicoRow:
            return TipoServicoRow(data);
          case ViewCountUsuarioEmpresaRow:
            return ViewCountUsuarioEmpresaRow(data);
          case UsuarioRow:
            return UsuarioRow(data);
          case TipoDespesaRow:
            return TipoDespesaRow(data);
          case ClienteRow:
            return ClienteRow(data);
          case DadosServicosRow:
            return DadosServicosRow(data);
          case EmpresaRow:
            return EmpresaRow(data);
          case UsuarioEmpresaRow:
            return UsuarioEmpresaRow(data);
          case TipoColaboradorRow:
            return TipoColaboradorRow(data);
          case ServicoRow:
            return ServicoRow(data);
          default:
            return null;
        }
