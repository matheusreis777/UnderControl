...
class _ClientesWidgetState extends State<ClientesWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultpCountClienteEmpresa =
          await ApiCountClienteEmpresaCall.call(
        empresaId: FFAppState().idEmpresa,
      );
      setState(() {
        _model.count = valueOrDefault<int>(
          getJsonField(
            (_model.apiResultpCountClienteEmpresa?.jsonBody ?? ''),
            r'''$''',
          ),
          0,
        );
                          ...
                          child: Container(
                            ...
                            child: FutureBuilder<List<ClienteRow>>(
                              future: (_model.requestCompleter ??=
                                      Completer<List<ClienteRow>>()
                                        ..complete(ClienteTable().queryRows(
                                          queryFn: (q) => q.eq(
                                            'empresa_id',
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ClienteRow> listViewClienteRowList =
                                    snapshot.data!;
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: listViewClienteRowList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewClienteRow =
                                        listViewClienteRowList[listViewIndex];
                                    return InkWell(
