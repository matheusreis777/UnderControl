...
class _TipoColaboradorWidgetState extends State<TipoColaboradorWidget>
  ...
  void initState() {
    ...
    _model.tipoController ??= TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return AuthUserStreamWidget(
      builder: (context) => FutureBuilder<int>(
        future: queryTipoColaboradorRecordCount(
          queryBuilder: (tipoColaboradorRecord) => tipoColaboradorRecord.where(
            'empresa',
        ...
        builder: (context, snapshot) {
          ...
          int tipoColaboradorCount = snapshot.data!;
              ...
              floatingActionButton: FloatingActionButton(
                onPressed: () async {
                  if (_model.tipoController.text == '') {
                    ...
                    await TipoColaboradorRecord.collection
                        .doc()
                        .set(createTipoColaboradorRecordData(
                          descricao: _model.tipoController.text,
                          empresa: currentUserDocument?.empresa,
                        ));
                    setState(() {
                      _model.tipoController?.clear();
                    });
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            if (tipoColaboradorCount.toString() == '0')
                              Column(
                                mainAxisSize: MainAxisSize.max,
                                          ...
                                          child: Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    8.0, 0.0, 8.0, 0.0),
                                            child: TextFormField(
                                              controller: _model.tipoController,
                                              focusNode: _model.tipoFocusNode,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                labelText:
                                                    'Informe aqui o novo tipo do colaborador',
                                                labelStyle:
                                    ...
                                    StreamBuilder<List<TipoColaboradorRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<TipoColaboradorRecord>
                                            listViewTipoColaboradorRecordList =
                                            snapshot.data!;
                                        return ListView.separated(
                                          ...
                                          itemBuilder:
                                            ...
                                            final listViewTipoColaboradorRecord =
                                                listViewTipoColaboradorRecordList[
                                                    listViewIndex];
                                            return Column(
                                              mainAxisSize: MainAxisSize.max,
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                ...
                                                                if (confirmDialogResponse) {
                                                                  await listViewTipoColaboradorRecord
                                                                      .reference
                                                                      .delete();
