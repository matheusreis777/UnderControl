  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRow> usuarioUsuarioRowList = snapshot.data!;
        final usuarioUsuarioRow = usuarioUsuarioRowList.isNotEmpty
            ? usuarioUsuarioRowList.first
            : null;
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        if (usuarioUsuarioRow?.foto != null &&
                                            usuarioUsuarioRow?.foto != '')
                                          ClipRRect(
                                            borderRadius:
                                          ...
                                          onPressed: () async {
                                            ...
                                            if ((_model.apiResult?.succeeded ??
                                              ...
                                              setState(() {
                                                _model.txtCepTextController
                                                        ?.text =
                                                    usuarioUsuarioRow!.cep!;
                                                _model.txtRuaTextController
                                                        ?.text =
                                                    usuarioUsuarioRow!.rua!;
                                                _model.txtNumeroTextController
                                                        ?.text =
                                                    usuarioUsuarioRow!.numero!
                                                        .toString();
                                                _model.txtBairroTextController
                                                        ?.text =
                                                    usuarioUsuarioRow!.bairro!;
                                                _model.txtComplementoTextController
                                                        ?.text =
                                                    usuarioUsuarioRow!
                                                        .complemento!;
                                                _model.txtCidadeTextController
                                                        ?.text =
                                                    usuarioUsuarioRow!.cidade!;
                                                _model.txtUfTextController
                                                        ?.text =
                                                    usuarioUsuarioRow!.uf!;
                                              });
